...
using ServiceOAuth.Controllers.Quickstart.Account;

namespace ServiceOAuth.Controllers.Quickstart.Consent
{
    /// <summary>
    ...
    [SecurityHeaders]
    [Authorize]
    public class ConsentController : GargleWoolControllerBase
    {
